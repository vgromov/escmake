...
include(${PROJECT_SOURCE_DIR}/escmake/escompiler.defs.msvc.cmake)
include(${PROJECT_SOURCE_DIR}/escmake/escompiler.defs.gnuc.cmake)
include(${PROJECT_SOURCE_DIR}/escmake/escompiler.defs.emb.cmake)
...
if(MSVC)
  ...
  set(CMAKE_CXX_FLAGS
    "${CMAKE_CXX_FLAGS} -D_CRT_SECURE_NO_WARNINGS -D_SCL_SECURE_NO_WARNINGS -DwxMSVC_VERSION=${ESCOMMON_COMPILER_VERSION} -DUNICODE -D_UNICODE"
  )
  set(CMAKE_C_FLAGS
    "${CMAKE_C_FLAGS} -D_CRT_SECURE_NO_WARNINGS -D_SCL_SECURE_NO_WARNINGS -DwxMSVC_VERSION=${ESCOMMON_COMPILER_VERSION} -DUNICODE -D_UNICODE"
  )  
endif()
